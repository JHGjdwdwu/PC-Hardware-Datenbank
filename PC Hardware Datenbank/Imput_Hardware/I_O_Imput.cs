...
namespace PC_Hardware_Datenbank
{
    public partial class I_O_Imput : Form
    {
        ...
        {
            if (wtxtHersteller.Text != "" && wtxtID.Text != "" && wtxtZustand.Text != "" && wtxtGerat.Text != "")
            {
                try
                {
                    ...
                    string mysqlcommandtext = "INSERT INTO `i-o` VALUES (" + sqldatensatz + ");";//SQL Befehl Abfrage aller User
